      ...
      <div className="relative w-full max-w-md bg-[#F5F6F8] h-full overflow-y-auto shadow-2xl">
        <div className="bg-ink-900 text-white p-5">
          <div className="flex items-center justify-between">
            ...
            <button onClick={deleteTruck} disabled={deleting} className="text-white/60 hover:text-alertred disabled:opacity-50" title="Eliminar camión">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2m3 0-1 14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2L4 6h16Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
            </button>
          </div>
