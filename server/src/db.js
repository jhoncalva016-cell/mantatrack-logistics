...
CREATE TABLE IF NOT EXISTS companies (
  ...
  name TEXT NOT NULL,
  city TEXT DEFAULT 'Quito, Ecuador',
...
function seedIfEmpty() {
  ...
  const companyId = insertCompany.run('CalGuy Track Logistics S.A.', 'Quito, Pichincha').lastInsertRowid;
  ...
  db.prepare(`INSERT INTO users (company_id, name, email, password_hash, role)
              VALUES (?, ?, ?, ?, ?)`)
    .run(companyId, 'Administrador CalGuy Track', 'admin@calguytrack.ec', passwordHash, 'admin');
  ...
  const trucks = [
    { code: 'CAM-01', plate: 'PBX-1234', driver: 'F. Cedeño', destination: 'Aeropuerto Mariscal Sucre', eta: '14:30', status: 'en_ruta', route_key: 'ruta1', route_index: 2, speed_kmh: 46 },
    { code: 'CAM-04', plate: 'PBX-4321', driver: 'R. Loor', destination: 'Sangolquí', eta: '--', status: 'detenido', route_key: 'ruta2', route_index: 5, speed_kmh: 0 },
    { code: 'CAM-03', plate: 'PBX-3344', driver: 'M. Ponce', destination: 'Cumbayá', eta: 'Entregado', status: 'entregado', route_key: 'ruta3', route_index: 8, speed_kmh: 0 },
    { code: 'CAM-06', plate: 'PBX-6677', driver: 'J. Moreira', destination: 'Sangolquí', eta: '15:10', status: 'desvio', route_key: 'ruta2', route_index: 3, speed_kmh: 38 },
    { code: 'CAM-07', plate: 'PBX-7788', driver: 'A. García', destination: 'Quito', eta: '16:00', status: 'en_ruta', route_key: 'ruta1', route_index: 6, speed_kmh: 52 },
    { code: 'CAM-02', plate: 'PBX-2233', driver: 'F. Cedeño', destination: 'Calderón', eta: '13:45', status: 'en_ruta', route_key: 'ruta4', route_index: 1, speed_kmh: 41 },
    { code: 'CAM-05', plate: 'PBX-5566', driver: 'R. Loor', destination: 'Cumbayá', eta: '17:20', status: 'en_ruta', route_key: 'ruta3', route_index: 2, speed_kmh: 44 },
    { code: 'CAM-08', plate: 'PBX-8899', driver: 'M. Ponce', destination: 'Quito', eta: '12:10', status: 'entregado', route_key: 'ruta4', route_index: 9, speed_kmh: 0 },
  ];
  ...
  const histRows = [
    [truck1, '2026-07-10', 'Quito', 'Aeropuerto Mariscal Sucre', 38, 38, 6.2, 'F. Cedeño'],
    [truck1, '2026-07-09', 'Quito', 'Sangolquí', 46, 65, 9.8, 'F. Cedeño'],
    [truck1, '2026-07-08', 'Sangolquí', 'Quito', 40, 57, 8.1, 'F. Cedeño'],
  ];
  ...
  insertAlert.run(companyId, camByCode('CAM-06'), 'desvio', 'high', 'El camión se desvió de la ruta establecida.', 'Sangolquí');
  insertAlert.run(companyId, camByCode('CAM-04'), 'detencion', 'medium', 'Lleva 12 minutos detenido sin reportar movimiento.', 'Vía Quito - Sangolquí');
  insertAlert.run(companyId, camByCode('CAM-02'), 'combustible', 'low', 'Nivel de combustible por debajo del 15%.', 'Quito');
  ...
  console.log('Usuario demo: admin@calguytrack.ec / mantatrack2026');
}
